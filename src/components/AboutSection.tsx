...
const AboutSection = () => {
  const highlights = [
    { icon: Code2, label: "Frontend", desc: "React, Vue, TypeScript" },
      ...
      <div className="container px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-center max-w-2xl mx-auto mb-16">
            Développeur passionné avec 5+ ans d'expérience dans la création de solutions digitales innovantes
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="w-64 h-64 md:w-80 md:h-80 mx-auto rounded-2xl bg-gradient-card border border-border overflow-hidden">
                <div className="w-full h-full bg-gradient-to-br from-primary/20 to-accent/20 flex items-center justify-center">
                  <span className="font-mono text-6xl text-gradient">AD</span>
                </div>
              </div>
          ...
          >
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Passionné par le code depuis mon plus jeune âge, j'ai transformé cette passion en métier. 
              Je crée des applications web performantes et des expériences utilisateur exceptionnelles.
            </p>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              Mon approche combine expertise technique et créativité pour résoudre des problèmes complexes 
              avec des solutions élégantes. J'aime apprendre de nouvelles technologies et partager mes connaissances.
            </p>
